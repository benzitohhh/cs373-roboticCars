...
#
# These 2 sections are straight: [(r,2r), (3r, 2r)] and [(3r,0), (r,0)] 
# Meanwhile these 2 sections are semicircular [(r,0), (0,r), (r,2r)] and [(3r,2r), (4r,r), (3r,0)],
# with centres at (r,r) and (4r,r) respectively.
# Hence the whole course is roughly oval.
# 
...
############## ONLY ADD / MODIFY CODE BELOW THIS LINE ####################
    ...
    def cte(self, radius):
        if self.x < radius:
            ...
            cx = radius
            cy = radius
            cte = sqrt((cx - self.x)**2 + (cy - self.y)**2) - radius
            ...
            if self.y >= radius:
                # top straight stretch
                cte = self.y - 2*radius
            else:
                # bottom straight stretch
                cte = -self.y
        return cte
